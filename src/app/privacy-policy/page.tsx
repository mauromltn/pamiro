         ...
         <main className="min-h-screen bg-[var(--primary)] text-[var(--secondary)] px-12 py-14">
            <section className="max-w-4xl mx-auto">
               <header>
                  ...
                  <h1 className="font-gambarino text-5xl mb-8">Privacy Policy</h1>
               ...
               <section className="space-y-8">
                  ...
                  <div>
                     <h2 className="font-gambarino text-3xl mb-4">2. Information We Collect</h2>
                  ...
                  <div>
                     <h2 className="font-gambarino text-3xl mb-4">3. How We Use Your Information</h2>
                     <ul className="list-disc list-inside space-y-2 text-[17px]">
                  ...
                  <div>
                     <h2 className="font-gambarino text-3xl mb-4">4. Information Sharing</h2>
                     <p className="text-[17px] mb-4">
                  ...
                  <div>
                     <h2 className="font-gambarino text-3xl mb-4">5. Data Security</h2>
                     <p className="text-[17px] ">
                  ...
                  <div>
                     <h2 className="font-gambarino text-3xl mb-4">6. Your Rights</h2>
                     <p className="text-[17px] mb-4">You have the right to:</p>
                     <ul className="list-disc list-inside space-y-2 text-[17px]">
                  ...
                  <div>
                     <h2 className="font-gambarino text-3xl mb-4">7. Cookies</h2>
                     <p className="text-[17px]">
                  ...
                  <div>
                     <h2 className="font-gambarino text-3xl mb-4">8. Data Retention</h2>
                     <p className="text-[17px]">
                  ...
                  <div>
                     <h2 className="font-gambarino text-3xl mb-4">9. Policy Updates</h2>
                     <p className="text-[17px]">
