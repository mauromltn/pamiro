         ...
         <main className="min-h-screen bg-[var(--primary)] text-[var(--secondary)] px-6 sm:px-12 py-14">
            <section className="max-w-4xl mx-auto">
               <header>
                  ...
                  <h1 className="font-gambarino text-4xl sm:text-5xl mb-6 sm:mb-8">Terms of Service</h1>
               ...
               <section className="space-y-6 sm:space-y-8">
                  <div>
                     ...
                     <p className="text-[15px] sm:text-[17px] leading-relaxed mb-3 sm:mb-4">
                  ...
                  <div>
                     <h2 className="font-gambarino text-2xl sm:text-3xl mb-3 sm:mb-4">2. Reservations</h2>
                  ...
                  <div>
                     <h2 className="font-gambarino text-2xl sm:text-3xl mb-3 sm:mb-4">3. Payment and Pricing</h2>
                     <ul className="list-disc list-inside space-y-2 text-[15px] sm:text-[17px] leading-relaxed">
                  ...
                  <div>
                     <h2 className="font-gambarino text-2xl sm:text-3xl mb-3 sm:mb-4">4. Food and Dietary Requirements</h2>
                     <ul className="list-disc list-inside space-y-2 text-[15px] sm:text-[17px] leading-relaxed">
                  ...
                  <div>
                     <h2 className="font-gambarino text-2xl sm:text-3xl mb-3 sm:mb-4">5. Conduct and Dress Code</h2>
                     <ul className="list-disc list-inside space-y-2 text-[15px] sm:text-[17px] leading-relaxed">
                  ...
                  <div>
                     <h2 className="font-gambarino text-2xl sm:text-3xl mb-3 sm:mb-4">6. Liability</h2>
                     <p className="text-[15px] sm:text-[17px] leading-relaxed mb-3 sm:mb-4">
                  ...
                  <div>
                     <h2 className="font-gambarino text-2xl sm:text-3xl mb-3 sm:mb-4">7. Website Use</h2>
                     <ul className="list-disc list-inside space-y-2 text-[15px] sm:text-[17px] leading-relaxed">
                  ...
                  <div>
                     <h2 className="font-gambarino text-2xl sm:text-3xl mb-3 sm:mb-4">8. Intellectual Property</h2>
                     <p className="text-[15px] sm:text-[17px] leading-relaxed">
                  ...
                  <div>
                     <h2 className="font-gambarino text-2xl sm:text-3xl mb-3 sm:mb-4">9. Changes to Terms</h2>
                     <p className="text-[15px] sm:text-[17px] leading-relaxed">
